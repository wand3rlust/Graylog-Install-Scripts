...
# Uninstall Bloatware
sudo apt-get remove --purge -y 2048-qt
sudo apt autoremove -y
sudo apt-get remove --purge -y qtpass*
sudo apt autoremove -y
sudo apt-get remove --purge -y kcalc
sudo apt autoremove -y
sudo apt-get remove --purge -y skanlite
sudo apt autoremove -y
sudo apt-get remove --purge -y quassel
sudo apt autoremove -y
sudo apt-get remove --purge -y transmission*
sudo apt autoremove -y
